...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if (formEmbaixador) {
    ...
    formEmbaixador.addEventListener('submit', async (e) => {
      ...
      const nome = (document.getElementById('nome-embaixador') as HTMLInputElement).value;
      const categoria = (document.getElementById('categoria-embaixador') as HTMLInputElement).value;
  ...
  if (formBuscarEmbaixadores) {
    formBuscarEmbaixadores.addEventListener('submit', async (e) => {
      e.preventDefault();
      const nomeEmbaixada = (document.getElementById('nome-embaixada-busca') as HTMLInputElement).value;
